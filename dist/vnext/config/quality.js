...
exports.AUDITION_GATE_THRESHOLD = exports.MIN_RULE_QUALITY = exports.MIN_QUALITY_THRESHOLD = exports.QUALITY_CONFIG = void 0;
exports.validateQualityConfig = validateQualityConfig;
exports.logQualityConfig = logQualityConfig;
...
exports.MIN_QUALITY_THRESHOLD = exports.QUALITY_CONFIG.CURRENT_THRESHOLD;
exports.MIN_RULE_QUALITY = exports.QUALITY_CONFIG.CURRENT_RULE_THRESHOLD;
exports.AUDITION_GATE_THRESHOLD = exports.QUALITY_CONFIG.CURRENT_AUDITION_THRESHOLD;
// Validation function to ensure all components use same thresholds
function validateQualityConfig() {
    const issues = [];
    const current = exports.QUALITY_CONFIG.CURRENT;
