...
const atoms_generator_1 = require("./explainer/atoms-generator");
const text_realizer_1 = require("./explainer/text-realizer");
...
async function runFinalValidation() {
    ...
    console.log('=' * 60);
    try {
        const atomsGenerator = new atoms_generator_1.AtomsGenerator();
        const textRealizer = new text_realizer_1.TextRealizer();
