...
const e2e_determinism_1 = require("./e2e-determinism");
/**
 * Run comprehensive E2E test suite
 */
async function runE2ETests(baseUrl = 'http://localhost:3000', artifactDir) {
    ...
    try {
        ...
        const determinismResult = await (0, e2e_determinism_1.runDeterminismTest)(composeEndpoint, testPayload, 5, artifactDir);
    ...
    try {
        ...
        const failResult = await (0, e2e_determinism_1.testFailClosed)(composeEndpoint, failPayload);
    ...
    try {
        ...
        const overlayResult = await (0, e2e_determinism_1.testOverlayThresholds)(composeEndpoint, basePayload);
