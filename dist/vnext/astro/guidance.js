...
exports.guidanceFromFeatures = guidanceFromFeatures;
exports.applyGuidanceBias = applyGuidanceBias;
/**
 * Compute astrological guidance from feature vector and chart context
 * Pure function with no side effects
 */
function guidanceFromFeatures(featureVec, chartContext) {
    var _a;
    ...
    const sunLon = ((_a = chartContext.planets.find(p => p.name === 'sun')) === null || _a === void 0 ? void 0 : _a.lon) || 0;
 ...
 */
function applyGuidanceBias(baseVector, guidance) {
