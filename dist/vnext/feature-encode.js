...
exports.encodeFeatures = encodeFeatures;
const clamp01 = (x) => Math.max(0, Math.min(1, x));
const normDeg = (d) => ((d % 360) + 360) % 360 / 360;
function encodeFeatures(s) {
    var _a, _b;
    ...
    for (const p of order) {
        f[i++] = normDeg((_b = (_a = s.planets.find(x => x.name === p)) === null || _a === void 0 ? void 0 : _a.lon) !== null && _b !== void 0 ? _b : 0);
    }
    // House cusps (10-21)
...
function clusterDensity(planets) {
